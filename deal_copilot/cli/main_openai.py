"""
Main entry point for Deal Co-Pilot POC - OpenAI Deep Research Agent
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='Deal Co-Pilot POC - OpenAI Deep Research Agent',
...
Examples:
  ...
  # Save output to file
  python main_openai.py --company "Bizzi" --sector "SaaS" --region "Vietnam" --website "https://bizzi.vn/en/" --output report.txt
        """
    )
    
    parser.add_argument('--company', type=str, help='Company name (e.g., Bizzi)')
    parser.add_argument('--sector', type=str, help='Sector/vertical (e.g., SaaS, Fintech, Marketplace)')
    parser.add_argument('--region', type=str, help='Geographic region (e.g., Vietnam, Southeast Asia)')
    parser.add_argument('--website', type=str, help='Company website URL')
    parser.add_argument('--hq', type=str, help='HQ location if different from region')
...
def get_interactive_input():
    ...
    print("\n" + "="*60)
    print("Deal Co-Pilot POC - OpenAI Deep Research Agent")
    print("="*60 + "\n")
